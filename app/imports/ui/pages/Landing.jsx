        ...
        <div className='img-background'>
          <Grid center stackable columns='3' container>
            ...
            <Grid.Column textAlign='center'>
              <Icon inverted color='white' size='massive' name='users'/>
            ...
            <Grid.Column textAlign='center'>
              <Icon inverted color='white' size='massive' name='file text outline'/>
            ...
            <Grid.Column textAlign='center'>
              <Icon inverted color='white' size='massive' large name='calendar check'/>
